...
const articles: Record<string, Record<"en" | "ar", Article>> = {
  "real-estate-installment-management": {
    ...
    ar: {
      ...
      excerpt: "العقد الموقّع هو بداية جدول سداد ٤ سنين. ده سبب فشل الإكسل في ده، وإيه اللي المفروض تتبّعه بدله.",
  ...
  "real-estate-lead-response-time": {
    ...
    ar: {
      ...
      excerpt: "استفسار العقار عمره قصير. معظم العملاء بيضيعوا بسبب العملية مش السعر — ده مكان التسريب.",
      author: "فريق فوكس سيستمز",
      date: "2026-09-24",
      category: "CRM",
  ...
  "pest-control-route-optimisation": {
    ...
    ar: {
      ...
      excerpt: "فني بيمرض واليوم لازم يتبني من الأول. ده اللي المفروض برنامج الجدولة يعمله فعلًا.",
      author: "فريق فوكس سيستمز",
      date: "2026-09-24",
      category: "البرمجيات",
      readTime: "٧ دقائق قراءة",
  ...
  "pest-control-device-monitoring": {
    ...
    ar: {
      ...
      excerpt: "علامة على ورقة ما بتثبتش حاجة. ده اللي سجلات الأجهزة بتدّيهولك والقائمة الورقية ما بتدّهوش.",
      author: "فريق فوكس سيستمز",
      date: "2026-09-24",
      category: "البرمجيات",
      readTime: "٧ دقائق قراءة",
  ...
  "pharma-visit-verification": {
    ...
    ar: {
      ...
      excerpt: "تقرير زيارة المندوب دعوى لحد ما حاجة تسندها. ده اللي بيتغيّر لما الزيارات تبقى موثّقة.",
      author: "فريق فوكس سيستمز",
      date: "2026-09-24",
      category: "CRM",
      readTime: "٧ دقائق قراءة",
  ...
  "pharma-sample-management": {
    ...
    ar: {
      ...
      excerpt: "مخزون العيّنات مش مخزون عادي. بيتنقل بين أيادي، وبينتهي، وممكن تحتاج تحاسب على تشغيلة واحدة.",
      author: "فريق فوكس سيستمز",
      date: "2026-09-24",
      category: "CRM",
      readTime: "٧ دقائق قراءة",
