...
const T = {
  ...
  ar: {
    ...
    sub: "تلات أنظمة CRM، كل واحد متبني لقطاع واحد مش متظبّط عليه. كلهم شغالين في الإنتاج النهارده، بالعربي والإنجليزي. افتح أي واحد تشوف شاشاته ومميزاته والرد على الأسئلة المعتادة.",
    open: "شوف النظام",
