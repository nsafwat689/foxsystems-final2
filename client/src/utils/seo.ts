...
export const arabicSEOConfigs: Record<string, SEOConfig> = {
  ...
  home: {
    ...
    description: "أنظمة CRM ومراكز اتصال وجدران حماية وVoIP وبنية تحتية في مصر والسعودية والكويت. أكثر من 300 عميل، أكثر من 16 سنة خبرة، ودعم 24/7.",
    ...
    ogDescription: "الشركة الأولى لتطبيق CRM في مصر. مراكز الاتصال، جدران الحماية، VoIP، شبكات. أكثر من 300 عميل.",
    ogImage: "https://foxsystemstech.com/og-image.jpg",
