...
const T = {
  ...
  ar: {
    ...
    includedItems: [
      "النظام القياسي، مهيّأ لمجال عملك",
      "واجهة كاملة بالعربية والإنجليزية، باتجاه من اليمين إلى اليسار",
      "التركيب ونقل البيانات وتدريب الفريق",
      "دعم على مدار الساعة، وزيارات ميدانية عند الحاجة",
      "بياناتك ملك لك، وتُصدَّر كاملةً عند الطلب",
    ],
    terms: "خيارات التعاقد",
    termItems: [
      "اشتراك شهري دون التزام طويل الأجل",
      "عقد ستة أشهر: شهر مجاني",
      "اشتراك سنوي: تدفع عشرة أشهر بدلًا من اثني عشر",
    ],
    ...
    fineprint: "الأسعار بالدولار الأمريكي شهريًا، غير شاملة الضرائب. وعرض السعر المكتوب صالح لمدة محدّدة.",
  },
};
