          ...
          <div className="grid lg:grid-cols-3 gap-16">
            <div className={`lg:col-span-2 space-y-16 ${isArabic ? "text-right" : ""}`}>
              ...
              <div className="space-y-8">
                <h2 className="text-3xl font-bold">{isArabic ? "القدرات" : "Capabilities"}</h2>
              ...
              {data.steps && (
                <div className="space-y-8">
                  <h2 className="text-3xl font-bold">{isArabic ? "دورة تقديم الخدمة" : "Service Delivery Cycle"}</h2>
                  <div className="space-y-6">
              ...
              {data.partners && (
                <div className="space-y-8">
                  <h2 className="text-3xl font-bold">{isArabic ? "الشركاء والبائعون" : "Partners & Vendors"}</h2>
          ...
          <div className="grid md:grid-cols-4 gap-12 mb-16">
            <div className="space-y-6">
              ...
              <p className="text-muted-foreground leading-relaxed">
                {isArabic ? "شريكك الموثوق للبنية التحتية المتكاملة لتكنولوجيا المعلومات." : "Your trusted partner for comprehensive IT infrastructure."}
              </p>
            </div>
            <div>
              <h4 className="font-bold text-xl mb-8">{isArabic ? "الخدمات" : "Services"}</h4>
              <ul className="space-y-4 text-muted-foreground">
                <li><Link href="/services/internet" className="hover:text-primary transition">{isArabic ? "الإنترنت" : "Internet"}</Link></li>
                <li><Link href="/services/software" className="hover:text-primary transition">{isArabic ? "البرمجيات" : "Software"}</Link></li>
                <li><Link href="/services/hardware" className="hover:text-primary transition">{isArabic ? "الأجهزة" : "Hardware"}</Link></li>
                <li><Link href="/services/cybersecurity" className="hover:text-primary transition">{isArabic ? "الأمن السيبراني" : "Cybersecurity"}</Link></li>
              </ul>
            </div>
            <div>
              <h4 className="font-bold text-xl mb-8">{isArabic ? "الشركة" : "Company"}</h4>
              <ul className="space-y-4 text-muted-foreground">
                <li><Link href="/about" className="hover:text-primary transition">{isArabic ? "حول" : "About"}</Link></li>
                <li><Link href="/contact" className="hover:text-primary transition">{isArabic ? "اتصل" : "Contact"}</Link></li>
              </ul>
            </div>
            <div>
              <h4 className="font-bold text-xl mb-8">{isArabic ? "اتصل" : "Contact"}</h4>
              <ul className="space-y-4 text-muted-foreground">
