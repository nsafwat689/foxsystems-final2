...
const articles: Record<string, Record<"en" | "ar", Article>> = {
  "real-estate-installment-management": {
    en: {
      ...
      excerpt: "A signed contract is the start of a four-year payment schedule. Here is why spreadsheets fail at it and what to track instead.",
    ...
    ar: {
      ...
      excerpt: "العقد الموقَّع هو بداية جدول سداد يمتد أربع سنوات. لماذا تفشل جداول إكسل في إدارته، وما الذي ينبغي تتبّعه بدلًا منها.",
  ...
  "real-estate-lead-response-time": {
    en: {
      ...
      excerpt: "A property enquiry has a short half-life. Most are lost to process, not to price — here is where they leak.",
      author: "Fox Systems Team",
      date: "2026-09-24",
      category: "CRM",
      readTime: "7 min read",
    ...
    ar: {
      ...
      excerpt: "عمر الاستفسار العقاري قصير، ويُفقد معظم العملاء بسبب آليات العمل لا بسبب السعر. إليك مواضع التسريب.",
      author: "فريق فوكس سيستمز",
      date: "2026-09-24",
      category: "CRM",
  ...
  "pest-control-route-optimisation": {
    en: {
      ...
      excerpt: "A technician calls in sick and the day has to be rebuilt. Here is what scheduling software actually has to do.",
      author: "Fox Systems Team",
      date: "2026-09-24",
      category: "Software",
      readTime: "7 min read",
    ...
    ar: {
      ...
      excerpt: "يمرض فنيّ فيلزم إعادة بناء اليوم بأكمله. هذا ما ينبغي أن يفعله برنامج الجدولة فعليًا.",
      author: "فريق فوكس سيستمز",
      date: "2026-09-24",
      category: "البرمجيات",
      readTime: "٧ دقائق قراءة",
  ...
  "pest-control-device-monitoring": {
    en: {
      ...
      excerpt: "A tick on a paper sheet proves nothing. Here is what device-level records give you that a checklist cannot.",
      author: "Fox Systems Team",
      date: "2026-09-24",
      category: "Software",
      readTime: "7 min read",
    ...
    ar: {
      ...
      excerpt: "علامة على ورقة لا تُثبت شيئًا. إليك ما تمنحه سجلات الأجهزة ولا تمنحه القوائم الورقية.",
      author: "فريق فوكس سيستمز",
      date: "2026-09-24",
      category: "البرمجيات",
      readTime: "٧ دقائق قراءة",
  ...
  "pharma-visit-verification": {
    en: {
      ...
      excerpt: "A medical rep's visit report is a claim until something backs it. Here is what changes when visits are verified.",
      author: "Fox Systems Team",
      date: "2026-09-24",
      category: "CRM",
      readTime: "7 min read",
    ...
    ar: {
      ...
      excerpt: "يظل تقرير زيارة المندوب مجرد ادّعاء حتى يسنده دليل. إليك ما يتغيّر حين تصبح الزيارات موثَّقة.",
      author: "فريق فوكس سيستمز",
      date: "2026-09-24",
      category: "CRM",
      readTime: "٧ دقائق قراءة",
  ...
  "pharma-sample-management": {
    en: {
      ...
      excerpt: "Sample stock is not ordinary inventory. It moves between hands, it expires, and you may have to account for one batch.",
      author: "Fox Systems Team",
      date: "2026-09-24",
      category: "CRM",
      readTime: "7 min read",
    ...
    ar: {
      ...
      excerpt: "مخزون العيّنات ليس مخزونًا اعتياديًا: ينتقل بين الأيدي، وينتهي صلاحيته، وقد تُطالَب بالمحاسبة على تشغيلة بعينها.",
      author: "فريق فوكس سيستمز",
      date: "2026-09-24",
      category: "CRM",
      readTime: "٧ دقائق قراءة",
  ...
  "real-estate-crm-egypt": {
    ...
    ar: {
      ...
      excerpt: "مبيعات العقارات ليست دورة بيع اعتيادية. إليك ما يجب أن يعالجه نظام CRM عقاري في مصر ولا يعالجه النظام العام.",
      category: "CRM",
      author: "فريق فوكس سيستمز",
      date: "2026-09-23",
  ...
  "pest-control-software-egypt": {
    ...
    ar: {
      ...
      excerpt: "مكافحة الآفات عمل قوامه خطوط السير والإثبات. إليك ما يجب أن يعالجه البرنامج ولا يعالجه نظام CRM عام أو سبورة.",
      category: "البرمجيات",
      author: "فريق فوكس سيستمز",
      date: "2026-09-23",
      readTime: "٨ دقائق قراءة",
  ...
  "medical-crm-pharma-egypt": {
    ...
    ar: {
      ...
      excerpt: "للفريق الميداني في شركات الأدوية متطلبات لا يوفّرها أي نظام CRM عام: زيارات قابلة للإثبات، وعهدة لتشغيلات العيّنات، وتغطية تُقاس على خطة.",
      category: "CRM",
      author: "فريق فوكس سيستمز",
      date: "2026-09-23",
      readTime: "٨ دقائق قراءة",
